...
const schema = yup.object({
  ...
  maRap: yup.string().required("This field is required"),
  tenRap: yup.string().required("This field is required"),
});
  ...
  const formIk = useFormik({
    ...
    onSubmit: (value) => {
      const payload = {
        ...
        ngayChieuGioChieu: dayjs(value.ngayChieuGioChieu).format(
          "DD/MM/YYYY hh:mm:ss"
        ),
      };
      ...
      <div className="movieScheduleContainer">
        ...
        <div className="bottom">
          <Form onSubmit={formIk.handleSubmit}>
            <div className="Img">
              <h1>
                {movieEdit.tenPhim} - {movieEdit.maPhim}
              </h1>
              <img
            ...
            >
              ...
              <Controls.BoxOfficeSelect
                ...
                onblur={formIk.handleBlur}
                options={
                  formIk.values.tenRap !== "" &&
                  Array.isArray(boxOfficeInfo) &&
                  boxOfficeInfo
                }
