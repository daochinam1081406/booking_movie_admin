...
const schema = yup.object({
  ...
  hot: yup.string().required("This field is required"),
  dangChieu: yup.string().required("This field is required"),
  sapChieu: yup.string().required("This field is required"),
});
...
const MovieEdit = () => {
  ...
  useEffect(() => {
    setInput(() => ({
      ...movieEdit,
      hot:
        typeof movieEdit.hot === "boolean"
          ? movieEdit.hot
            ? "true"
            : "false"
          : movieEdit.hot,
      dangChieu:
        typeof movieEdit.dangChieu === "boolean"
          ? movieEdit.dangChieu
            ? "true"
            : "false"
          : movieEdit.dangChieu,
      sapChieu:
        typeof movieEdit.sapChieu === "boolean"
          ? movieEdit.sapChieu
            ? "true"
            : "false"
          : movieEdit.sapChieu,
              ...
              <Grid item xs={6}>
                ...
                <div>
                  <div className="formInput">
                    ...
                    />
                    {file === undefined && (
                      <p style={{ color: "red" }}>Image file is required</p>
                    )}{" "}
                  </div>
                  <img
                    src={
                      file ? URL.createObjectURL(file) : formIk.values.hinhAnh
                    }
                    alt=""
                    width="250px"
                    height="250px"
